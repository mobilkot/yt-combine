                        ...
                        <div class="divTableBody yota_new_style_apps">
                            <div class="divTableRow ">
                                ...
                                <div class="divTableCell">
                                    <input data-name="vk" id="app-vk_${type}" class="input_app-vk" type="checkbox" name="select_apps_${type}" value="1" onchange='updateLegoInfo(this, "${type}")'">  
                                    <label for="app-vk_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="vk_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>

                                <div class="divTableCell">
                                    <input data-name="ig" id="app-ig_${type}" class="input_app-ig" type="checkbox" name="select_apps_${type}" value="4" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-ig_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="ig_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>

                                </div>
                                <div class="divTableCell">
                                    <input data-name="fb" id="app-fb_${type}" class="input_app-fb" type="checkbox" name="select_apps_${type}" value="3" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-fb_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="fb_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                                <div class="divTableCell">
                                    <input data-name="ok" id="app-ok_${type}" class="input_app-ok" type="checkbox" name="select_apps_${type}" value="2" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-ok_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="ok_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                                <div class="divTableCell">
                                    <input data-name="tw" id="app-tw_${type}" class="input_app-tw" type="checkbox" name="select_apps_${type}" value="5" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-tw_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="tw_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div></div>
                            <div class="divTableRow">
                                <div class="divTableCell">
                                    <input data-name="vi" id="app-vi_${type}" class="input_app-vi" type="checkbox" name="select_apps_${type}" value="7" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-vi_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="vi_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                                <div class="divTableCell">
                                    <input data-name="wh" id="app-wh_${type}" class="input_app-wh" type="checkbox" name="select_apps_${type}" value="8" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-wh_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="wh_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                                <div class="divTableCell">
                                    <input data-name="sk" id="app-sk_${type}" class="input_app-sk" type="checkbox" name="select_apps_${type}" value="6" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-sk_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="sk_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                            ...
                            <div class="divTableRow">
                                <div class="divTableCell">
                                    <input data-name="yt" id="app-yt_${type}" class="input_app-yt" type="checkbox" name="select_apps_${type}" value="9" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-yt_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="yt_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                            </div>
                            <div class="divTableRow">
                                <div class="divTableCell">
                                    ...
                                    <input data-name="sm" id="app-sm_${type}" class="input_app-sm" type="checkbox" name="select_sms_${type}" value="10" onchange='updateLegoInfo(this, "${type}")'">  <label for="app-sm_${type}" class="layout-buttons"><span> <div data-name="vk" class="b-voice-calculator__application-icon"> 
                                       <div class="b2c-voice-collect__app-price" data-name="app-social_${type}" data-for="sm_${type}"  tooltip-position='left'> <div class="b2c-voice-collect__app-price_text"> 20&#8381; </div> </div>   
                                       </div></span></label>
                                </div>
                            </div>
                        </div> 
...
function updateLegoInfo(obj, types) {
    ...
    let te2 = te1.querySelector('#yota_copy_text');
    if(te2.innerText==="СКОПИРОВАНО!")
        te2.innerText='';
...
function getLocalTime(timezone, callback){
    ...
    reqw.open( 'GET', 'https://cors.io/?https://yandex.com/time/sync.json?geo='+timezone , true );
    ...
    reqw.onreadystatechange = function () {
        ...
        if ( reqw.readyState === 4 && reqw.status === 200)   {
            ...
            getTimeStamp(reqw.response, callback, timezone);
...
function getTimeStamp(response, callback, timezone){
    ...
    //obj.clocks."timazone".offset
    //{"time":1537145528368,"clocks":{"240":{"id":240,"name":"Тольятти","
    // offset":14400000,"offsetString":"UTC±0:00","showSunriseSunset":true,"sunrise":"06:18","
    // sunset":"18:53","isNight":true,"skyColor":"#000f27","weather":{"temp":17,"icon":"ovc-minus-ra",
    // "link":"/togliatti"},"parents":[{"id":11131,"name":"Самарская область"},{"id":225,"name":"Россия"}]}}}
    let  time = response.clocks[timezone].offset;
    ...
    let offsets = time; // get DST and time zone offsets in milliseconds
    ...
    let timezonemsk =   (offsets/1000/60/60)-3;
...
function copyTextRate(elem){
    ...
    let texts = elem.querySelector('#yota_copy_text');
